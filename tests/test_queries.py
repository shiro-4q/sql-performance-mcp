...
class QueryTests(unittest.TestCase):
    ...
    def test_extract_table_names_supports_sql_server_and_postgres_quotes(self) -> None:
        sql = """
        SELECT u.id, o.id
        FROM [dbo].[users] u
        ...
        self.assertEqual(extract_table_names(sql), ["[dbo].[users]", '"public"."orders"'])
    ...
    def test_split_table_name_uses_default_schema(self) -> None:
        ...
        self.assertEqual(split_table_name("[dbo].[users]"), ("dbo", "users"))
        self.assertEqual(split_table_name("db.schema.users"), ("schema", "users"))
